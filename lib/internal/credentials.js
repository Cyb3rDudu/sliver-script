...
exports.createSliverRpcCredentials = createSliverRpcCredentials;
const grpc = __importStar(require("@grpc/grpc-js"));
function createSliverRpcCredentials(config) {
    ...
    return grpc.credentials.combineChannelCredentials(grpc.credentials.createSsl(ca, privateKey, certificate, {
